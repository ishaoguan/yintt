...
function addImage(src, pid,imgurl){
	...
	if(typeof swf_justimg != 'undefined' && swf_justimg == true){
		newImgDiv.innerHTML = '<a href="'+src+'" target="_blank"><img src="'+get_thumb_img(src)+'"/></a>';
		newImgDiv.innerHTML += '<input type="hidden" name="swfimglist[]" value="'+src+'" />';
	}else{
		newImgDiv.innerHTML = '<a href="'+src+'" target="_blank"><img src="'+get_thumb_img(src)+'" width="120" height="120" /></a>'+delstr;
