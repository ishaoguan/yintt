...
class VerifyVideoAction extends ACommonAction
{
    ...
    */
    public function index()
    {
		...
		$field= 'v.id,v.add_time,v.uid,v.apply_status,m.user_phone,m.reg_time,m.user_name,mi.real_name,mm.money_freeze,mm.money_collect,mm.account_money';
	...
	public function doEdit(){
        ...
        if ($result = $model->save()) { //保存成功
			...
			if($_POST['apply_status'] == 1){
				...
				if($xcount!=1) M('members_status')->add(array("uid"=>$uid,'video_status'=>1));
				else M('members_status')->where("uid={$uid}")->setField('video_status',1);
			}else{
