...
class MfieldsAction extends ACommonAction
{
    ...
    */
	...
	public function deletefile(){
			...
			if($result) $this->success("文件删除成功",'',array("data"=>$lineid));
	...
	public function deletedir(){
			...
			if($result) $this->success("文件夹删除成功",'',array("data"=>$lineid));
	...
	public function movedir(){
			...
			if($result==1) $this->success("文件移动成功",'',array("data"=>$sid));
