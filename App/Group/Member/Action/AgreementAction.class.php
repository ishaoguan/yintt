...
class AgreementAction extends MCommonAction {
	...
	public function _MyInit(){
		...
		//页头
		//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "", str_replace("http://","","http://".$_SERVER['HTTP_HOST']));
    ...
    public function downfile(){
		...
		$this->mypdf->Image(K_PATH_MAIN.'../../../Style/seal/images/bg.png', 35, 130, 143, 44, '', '', '', false, 300, '', false, false, 0);//出图的,放在后面图就在上层，放在前面图就在下层
		...
		$this->mypdf->Image(K_PATH_MAIN.'../../../Style/seal/images/seal.png', 10, 170, '145', '46', '', '', '', false, 300, '', false, false, 0);//出图的,放在后面图就在上层，放在前面图就在下层		
		ob_end_clean();
