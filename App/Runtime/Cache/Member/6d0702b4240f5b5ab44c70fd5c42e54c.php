...
<title>找回支付密码-- <?php echo ($glo["web_name"]); ?></title>
﻿
<meta http-equiv="X-UA-Compatible" content="IE=8"/>
            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
                        <li><a href="#fragment-1">重设支付密码</a></li>
					</ul>
				</div> 
				<div class="contentright">
					<div id="fragment-1">
						...
						<div style="text-align: center; width: 740px; height: 30px; margin: 10px;">
							<img id="btn_set" class="img_button" onclick="ResetPwd_pin()" src="__ROOT__/Style/M/images/btnsubupdate.jpg">
						</div>
						<input type="hidden" id="is_third_first" value="<?php echo ($is_third_first); ?>" />
						<script type="text/javascript">
							var newTitle = '<?php echo ($glo["web_name"]); ?>提醒您：';
						
							function ResetPwd_pin() {
								...
								if (hasErr_pin()) {
									...
									$.ajax({
										url: "__URL__/changenewpin/",
										type: "post",
										dataType: "json",
										data: {"newpwd1":newspwd1,"newpwd2":newspwd2},
										success: function(d) {
											if (d.status == "1") {
												$.jBox.tip('恭喜您，支付密码修改成功！','success');
