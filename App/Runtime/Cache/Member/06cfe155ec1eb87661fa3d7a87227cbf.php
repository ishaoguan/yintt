   ...
   <div id="us_r">
    <!-- Right -->
     ...
     <div class="us_rh" id="rotate">
      <ul>
       <li><a href="#fragment-1" ajax_href="__URL__/header/">我的头像</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-2" ajax_href="__URL__/password/">修改密码</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-3" ajax_href="__URL__/pinpass/">修改支付密码</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-4" ajax_href="__URL__/third/">三方用户设置</a></li>
       <li class="usrhDiv"></li>
      </ul>
     </div>
     <div class="us_rb4">
