...
<link rel="stylesheet" type="text/css" href="__ROOT__/Style/H/css/by_jiedai.css" />
<link rel="stylesheet" type="text/css" href="__ROOT__/Style/H/css/by_bangzhu.css" />
<style type="text/css">
#maincontent{background:url(__ROOT__/Style/H/images/bg-body.jpg) repeat}
.tip,.tipNoBg{ background:#0697DA; color:#fff; text-indent:15px; font-size:14px; text-align:left; padding:10px 0px}
.tip{
    background-color: #fff;
    color: #FFCC00;
}
.ax{position:relative; z-index:10; height:35px; border-bottom:2px solid #DFDDDE; overflow:hidden; margin-top:20px}
.mn_dk{position:relative; z-index:15; margin-left:0px}
.borrowtable{width:100%}
...
<center>
  <div style="width:980px;">
    <div id="maincontent">
      <div class="tipNoBg">
        <?php if($vipTime > 0): ?>您的已经是VIP会员，将于<?php echo (date("Y年m月d日",$vipTime)); ?>到期，你现在申请可延长VIP会员时间
          <?php else: ?>
          您正在申请VIP会员<?php endif; ?>
      </div>
            ...
            <div class="axbody">
              ...
              <table class="borrowtable">
                <tr>
                  ...
                  <td class="col_2" style="width:60%" colspan="3"><?php echo ($glo["fee_vip"]); ?>元/年</td>
                </tr>
                <tr>
                  <th class="col_1">请先择当前居住城市：</th>
                  <td class="col_2" style="width:60%" colspan="3"><select name="province_now" id="province_now" class="sel_fs">
                      <option>请选择</option>
                    </select>
                    &#12288;（省/直辖市）&#12288;
                    <select name="city_now" id="city_now" class="sel_fs">
                      <option>请选择</option>
                    </select>
                    &#12288;市&#12288;
                    <select name="area_now" id="area_now" class="sel_fs">
                      <option>请选择</option>
                    </select>
                    &#12288;区
                    <input id="gkf" type="button" onclick="getkf()" value="确定地区"  class="addbtn" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  <th class="col_1">&nbsp;</th>
                  <td class="col_2" style="width:60%" colspan="3"><input type="button" id="subd" onclick="cksubmit()" value="提交申请" class="addbtn" /></td>
                </tr>
              </table>
            </div>
          </ul>
...
<!--中部结束-->
<script type="text/javascript">
<?php if($vipTime > 0): ?>var tipS = '您的已经是VIP会员，将于<?php echo (date("Y年m月d日",$vipTime)); ?>到期，你现在申请可延长VIP会员时间\r\n确定要申请延长VIP权限吗？';
if(!confirm(tipS)) window.location.href="__APP__/member";<?php endif; ?>
...
function getkf(){
  var p=makevar(['province_now','city_now','area_now']);
	if(typeof p.province_now == "undefined") 			return setError("必须选择当前居住地省份！");
	if(typeof p.city_now == "undefined")				return setError("必须选择当前居住地城市！");
