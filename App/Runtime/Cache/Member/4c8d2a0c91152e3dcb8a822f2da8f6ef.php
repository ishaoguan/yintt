   ...
   <div id="us_r">
    <!-- Right -->
     ...
     <div class="us_rh" id="rotate">
      <ul>
       <li><a href="#fragment-1" ajax_href="__URL__/summary/" id="mx1">投资总表</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-2" ajax_href="__URL__/tending/" id="mx2">竞标中的投资</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-3" ajax_href="__URL__/tendbacking/" id="mx3">回收中的投资</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-4" ajax_href="__URL__/tendbreak/" id="mx4">逾期的投资</a></li>
       <li class="usrhDiv"></li>
       <li><a href="#fragment-5" ajax_href="__URL__/tenddone/" id="mx5">已回收的投资</a></li>
       <li class="usrhDiv"></li>
      </ul>
     </div>
     <div class="us_rb4">
