...
<div class="so_main">
  <div class="page_tit">初审待审核借款</div>
<!--搜索/筛选会员-->
...
<!--搜索/筛选会员-->
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td>
            ...
            <a href="javascript:void(0);" onclick="showurl('__ROOT____GROUP__/log/logList?id=<?php echo ($vo['id']); ?>&opType=<?php echo ($logOpType['BORROW_OPT'][0]); ?>','借款标操作日志');">日志</a>
        </td>
