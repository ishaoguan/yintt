...
<div class="so_main">
  <!--列表模块-->
  <form name="sdf" id="sdf" action="__GROUP__/capital_all/index" method="get">
  ...
  <div class="list">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td valign="top">
         	...
         	<dl class="lx"><dt>已还款总额:</dt><dd><?php echo (fmoney($list["32"]["money"])); ?></dd></dl>
         	<dl class="lx"><dt>未还款总额:</dt><dd><?php echo Fmoney($list['17']['money']-$list['32']['money']);?></dd></dl>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <dl class="lx"><dt>总计:</dt><dd><?php echo Fmoney($list['28']['money']+$list['21']['money']);?>
</dd></dl>
        </td>
      </tr>
    <tr>
        <th class="line_l">风险控制</th>
        <th class="line_l"></th>
        <th class="line_l"></th>
    </tr>
    <tr>
        <td valign="top">
         	<dl class="lx"><dt>可提现总额:</dt><dd><?php echo (fmoney($list["all_carry"])); ?></dd></dl>
        </td>
        <td valign="top">
        </td>
        <td valign="top">
