...
<script type="text/javascript">
	var delUrl = '__GROUP__/capital_online/doDel';
	var addUrl = '__GROUP__/capital_online/add';
...
<!--搜索/筛选会员-->
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="__GROUP__/capital_online/charge">
...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="__GROUP__/capital_online/chargeexport?<?php echo ($query); ?>"><span>将当前条件下数据导出为Excel</span></a>
  </div>
