...
<title><?php echo ($glo["index_title"]); ?>-<?php echo ($vo["type_name"]); ?>-<?php echo ($glo["web_name"]); ?>客服中心</title>
...
$(document).ready(function(){
   ...
   <div id="content">
    ...
    <div id="art_content">
     ...
     <!-- Right -->
       <div id="proShow">
     <?php if(is_array($kflist)): $i = 0; $__LIST__ = $kflist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i; if($i%3 == 1): ?><ul><?php endif; ?>
	      <li>
	       <a href="javascript:void(0)"><img class="head" src="<?php echo (get_avatar($vl["id"]+10000000)); ?>"></a>
	       <p>姓名：<?php echo ($vl["real_name"]); ?></p>
	       <p>电话:<?php echo ($vl["land_line"]); ?></p>
	       <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo ($vl["qq"]); ?>&amp;site=qq&amp;menu=yes" target="_blank">
	       	<img border="0" src="__ROOT__/Style/H/images/qqchat.png" title="点击这里给我发消息" alt="点击这里给我发消息">
	       </a>
	      </li>
	      <?php if($i%3 != 0): ?><li class="int">&nbsp;</li><?php endif; ?>
