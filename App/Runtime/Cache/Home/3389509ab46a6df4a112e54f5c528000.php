...
<title><?php echo ($glo["index_title"]); ?>-我要借款</title>
<meta name="keywords" content="<?php echo ($glo["web_keywords"]); ?>" />
<meta name="description" content="<?php echo ($glo["web_descript"]); ?>" />
<link rel="stylesheet" type="text/css" href="__ROOT__/Style/gold/css/borrow.css?<?php echo C('APP_RES_VER');?>" />
﻿
<meta http-equiv="X-UA-Compatible" content="IE=8"/>
   ...
   <div id="content">
    <div id="left">
     <!-- Left -->
      ...
      <div class="lb5_h"><h4><span>抵押</span>借款</h4><p>抵押标说明：抵押标是一种以固定资产为押低，通过线下审核才能通过初审的标的类似</p></div>
      <div class="lb5">
       <div class="lb5_upper"><p>申请条件：<span>1.注册用户</span><span>2.通过实名认证</span><span>3.资料认证</span></p></div>
       <div class="lb5_lower">
        <div class="lb5_ll">
        ...
        <div class="lb5_lr"><input type="button" class="bor_but" value="立即借入" onclick="window.location.href='__URL__/post/mortgage.html'" /><p>已有<span><?php echo (($allStat[5])?($allStat[5]):0); ?></span>个该类型借款</p></div>
       </div>
      </div>
      ...
      <div class="lb4">
       ...
       <div class="lb4_lower">
        ...
        <div class="lb4_lr"><input type="button" class="bor_but" value="立即借入" onclick="window.location.href='__URL__/post/second.html'" /><p>已有<span><?php echo (($allStat[3])?($allStat[3]):0); ?></span>个该类型借款</p></div>
       </div>
      </div>
      
      <div class="lb6_h"><h4><span>助学</span>借款</h4><p>助学标说明：助学标是一种以固定资产为押低，通过线下审核才能通过初审的标的类似</p></div>
      <div class="lb6">
       <div class="lb6_upper"><p>申请条件：<span>1.注册用户</span><span>2.通过实名认证</span><span>3.资料认证</span></p></div>
       <div class="lb6_lower">
        <div class="lb6_ll">
         <table width="358" border="0" cellspacing="0" cellpadding="0">
          <tr>
        ...
        <div class="lb6_lr"><input type="button" class="bor_but" value="立即借入" onclick="window.location.href='__URL__/post/mortgage.html'" /><p>已有<span><?php echo (($allStat[6])?($allStat[6]):0); ?></span>个该类型借款</p></div>
       </div>
      </div>
