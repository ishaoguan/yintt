     ...
     <div class="us_rb5">
      ...
      <div class="us_rb5_upper">
       ...
       <div class="us_rb5_upper_r">
        <h2>邀请好友送奖金</h2>
        <p>邀请好友成功投标（不包含秒还标、净值标交易），立即送您<span>千分之2</span>的奖金，赶快行动吧。</p>
       </div>
      </div>
    <?php if(session('u_id') !=''): ?><ul>
       <li><p>您的邀请链接：</p><input id="txt_links" type="text" class="invi_text" readonly="readonly" value="https://<?php echo $_SERVER['HTTP_HOST'];?>/member/common/register?invite=<?php echo session('u_id');?>" /></li>
