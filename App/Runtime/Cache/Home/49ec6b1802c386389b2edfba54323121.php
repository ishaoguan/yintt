...
<title>实时财务-<?php echo ($glo["index_title"]); ?>-<?php echo ($glo["web_name"]); ?></title>
...
<div id="rea">
 ...
 <div id="finance_h"><h4><?php echo ($glo["web_name"]); ?>实时财务数据<span></span></h4></div>
  ...
  <div id="topPart">
   <div id="topPart_l">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      <th>总成交金额</th>
      <td><span><?php echo (fmoney($staticslist["17"]["money"],false)); ?></span></td>
      <td>&nbsp;</td>
     </tr>
     <tr>
      <th>总成交借款笔数</th>
...
$('#pieChart').gchart({type: 'pie3D', series: data, legend: 'right', 
    dataLabels: ['逾期率', '正常数据'], 
    extension: {chdl: "逾期率:<?php echo $expiredratestr; ?>|正常数据:<?php echo $normalratestr; ?>"}});
});
//-->
</script>
</div>
