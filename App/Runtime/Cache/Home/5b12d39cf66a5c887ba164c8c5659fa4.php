...
<title><?php echo ($vo["title"]); ?>-<?php echo ($glo["web_name"]); ?>-<?php echo (getdefaultseoinfo($vo["art_keyword"],1)); ?></title>
<meta name="keywords" content="<?php echo (getdefaultseoinfo($vo["art_keyword"],1)); ?>" />
<meta name="description" content="<?php echo (getdefaultseoinfo($vo["art_info"],2)); ?>" />
...
$(document).ready(function(){
   ...
   <div id="pos">
    <ul>
     ...
     <li class="posDiv"></li>
     <li><p><?php echo ($cat["type_name"]); ?></p></li>
    </ul>
   </div>
     ...
     <!-- Right -->
       ...
       <div id="news">
        ...
        <div id="news_content">
         ...
         <h6>发表时间：<?php echo (date("Y-m-d H:i",$vo["art_time"])); ?></h6>
